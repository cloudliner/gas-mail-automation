...
function automaticArchive() {
  ...
  try {
    var spreadsheet = SpreadsheetApp.openById('11GRPQyKcAVvmeLnFARytOmOr3vc0yBB4gP2NRFn7nmk');
    ...
    rowSettings.forEach(function(rowSetting) {
      ...
      var labelNames = rowSetting[3];
      var detailConditionSheetName = rowSetting[4];
      var labelsToBeRemovedSheetName = rowSetting[5];
      var ignoreImportance = rowSetting[6];
      var searchMax = rowSetting[7];
      ...
      if (sheetLabels != null) {
        ...
        rowLabels.forEach(function(rowLabel) {
          var labelNameToBeRemoved = rowLabel[0];
